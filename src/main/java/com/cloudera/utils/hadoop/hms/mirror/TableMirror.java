    ...
    public Boolean buildTableSchema(CopySpec copySpec) {
        ...
        try {
            ...
            if (source.getExists()) {
                ...
                if (getParent().getConfig().getEvaluatePartitionLocation() &&
...
//    }
    ...
    public String getCreateStatement(Environment environment) {
        ...
        Boolean cine = getParent().getConfig().getCluster(environment).getCreateIfNotExists();
    ...
    public String getUnique() {
        return df.format(getParent().getConfig().getInitDate());
//        return unique;
    }
