...
//                    // For distcp.
//                    addLocation(config.getResolvedDB(tblMirror.getParent().getName()), Environment.RIGHT, partitionLocation,
...
//        String dbName = config.getResolvedDB(tableMirror.getParent().getName());
//
