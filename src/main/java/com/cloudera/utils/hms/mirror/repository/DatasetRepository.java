...
/**
 * Repository interface for Dataset persistence operations.
 * Extends the base RocksDBRepository with Dataset-specific operations.
 */
public interface DatasetRepository extends RocksDBRepository<DatasetDto, String> {
