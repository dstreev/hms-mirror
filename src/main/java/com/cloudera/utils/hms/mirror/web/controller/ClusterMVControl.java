...
public class ClusterMVControl {
    ...
    public String save(Model model,
        ...
        cluster.setHiveServer2(currentCluster.getHiveServer2());
        cluster.setMetastoreDirect(currentCluster.getMetastoreDirect());

        // Update the cluster in the config.
        currentConfig.getClusters().put(environment, cluster);
