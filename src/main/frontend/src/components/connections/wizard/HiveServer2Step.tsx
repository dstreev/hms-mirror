    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          placeholder="hdfs://namenode:8020 , ofs://myzone, or s3a://bucket-name"
        />
        {errors.hcfsNamespace && (
          <p className="mt-1 text-sm text-red-600">{errors.hcfsNamespace}</p>
        )}
        <p className="mt-1 text-xs text-gray-500">
          📂 For Target (RIGHT) clusters, this identifies the namespace where locations will be anchored. Supports HDFS, S3, ADLS, OFS, etc.
        </p>
      </div>
