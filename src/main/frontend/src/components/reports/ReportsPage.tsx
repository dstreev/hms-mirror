...
const ReportsPage: React.FC = () => {
  ...
  const loadReports = async () => {
    try {
      console.log('loadReports called, making API call...');
      setIsLoading(true);
      setError(null);
      ...
      const data: ReportsBrowseResponse = await response.json();
      console.log('API response data:', data);
      console.log('Setting browse data...');
      setBrowseData(data);
      console.log('Browse data set successfully');
  ...
  return (
    <div className="p-8">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Reports */}
        {browseData.reports.length === 0 && browseData.directories.length === 0 ? (
          <div className="text-center py-12">
            <DocumentTextIcon className="h-16 w-16 text-gray-400 mx-auto mb-4" />
            <h2 className="text-xl font-medium text-gray-900 mb-2">No Reports Found</h2>
            <p className="text-gray-600">
              {browseData.message || "No migration reports found in this directory"}
            </p>
            {browseData.message && (
          ...
          <div>
            <h2 className="text-lg font-medium text-gray-900 mb-4">Migration Reports</h2>
