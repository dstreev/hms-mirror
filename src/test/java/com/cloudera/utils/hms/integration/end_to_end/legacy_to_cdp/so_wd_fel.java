...
//                "--hms-mirror.config.migrate-acid-only=true",
                "--hms-mirror.config.warehouse-directory=/wrehouse/tablespace/managed/hive", // should trigger warnings, but not affect location.
...
//                "--hms-mirror.config.reset-to-default-location=true",
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/so_wd_fel"
        })
@Slf4j
public class so_wd_fel extends E2EBaseTest {
...
//        validateTableLocation(resultsMirrors[0], "ext_part_01", Environment.RIGHT, "hdfs://HOME90/warehouse/tablespace/external/hive/assorted_test_db.db/ext_part_01");
    ...
    public void issueTest_01() {
        validateTableIssueCount("ext_purge_odd_parts", "ext_part_01",
                Environment.RIGHT, 3);
    }
    ...
    public void phaseTest_01() {
        validatePhase("ext_purge_odd_parts", "ext_part_01", PhaseState.SUCCESS);
    }
