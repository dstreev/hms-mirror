...
//                "--hms-mirror.config.target-namespace=s3a://my_cs_bucket",
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/so_wd_rdl_dc"
        })
@Slf4j
public class Test_so_wd_rdl_dc extends E2EBaseTest {
...
//        rtn = mirror.go(args);
//        int check = 3;//acid tables (fixed issue on load test data to filter out tables that don't match request.)
    // Should be 0 errors.
