...
//        }
    ...
    @Test
    public void sqlTest() {
        validateTableSqlPair("ext_purge_odd_parts", Environment.LEFT, "web_sales", "Alter Table Location",
                "ALTER TABLE web_sales SET LOCATION \"ofs://OHOME90/finance/external-fso/ext_purge_odd_parts.db/web_sales\"");
        validateTableSqlPair("ext_purge_odd_parts", Environment.LEFT, "web_sales",
                "Alter Table Partition Spec `ws_sold_date_sk`='2451180' Location",
