...
//                "--hms-mirror.config.distcp=true",
                "--hms-mirror.config.transfer-ownership=true",
                "--hms-mirror.conversion.test-filename=/test_data/assorted_tbls_01.yaml",
                "--hms-mirror.config.filename=/config/default.yaml.hdp2-cdp",
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/so_to"
        })
@Slf4j
public class Test_so_to extends E2EBaseTest {
