...
//                .getTableMirrors().get("legacy_mngd_01").getStrategy().toString());
    ...
    @Test
    public void checkDatabaseLocationAlignment() {
...
//        assertTrue(foundDbLocation, "Database should be aligned to external warehouse directory");
    ...
    @Test
    public void checkDatabaseManagedLocationAlignment() {
...
//        assertTrue(foundManagedLocation, "Database should have managed location set to managed warehouse directory");
    ...
    public void validateExportImportOperations() {
        ...
        validateTableSqlAction("assorted_test_db", "acid_01", LEFT, "EXPORT TABLE acid_01 TO");
...
//        assertTrue(foundExport, "Should have EXPORT operation for ACID table");
        ...
        validateTableSqlAction("assorted_test_db", "acid_01", RIGHT, "IMPORT TABLE acid_01 FROM");
...
//        assertNotNull(acid01Right, "RIGHT environment should exist for EXPORT_IMPORT");
    ...
    public void validateSQLStrategyTables() {
        ...
        assertNotNull(tableMirror.getEnvironmentTable(TRANSFER), "ACID strategy should have TRANSFER table");
...
//        }
    ...
    @Test
    public void checkMetadataProperties() {
        // Tables should have metadata handling with warehouse alignment
        TableMirror tableMirror = getTableMirrorOrFail("assorted_test_db", "acid_01");
        assertNotNull(tableMirror.getEnvironmentTable(Environment.RIGHT), "RIGHT environment should exist with warehouse alignment");
