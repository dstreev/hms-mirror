...
//                "--hms-mirror.config.distcp=true",
                ...
                "--hms-mirror.config.comment='SQL Sync test.  Should result in a table being DROP on the RIGHT because it's missing on the LEFT'"
        })
@Slf4j
public class Test_sql_sync extends E2EBaseTest {
