...
@SpringBootTest(classes = Mirror.class,
        args = {
                "--hms-mirror.config.comment='Test the DUMP Strategy.  Include ACID tables and Partition Details.'",
...
//                "--hms-mirror.config.distcp=true",
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/dump_ma_epl"
        })
@Slf4j
public class Test_dump_ma_epl extends E2EBaseTest {
