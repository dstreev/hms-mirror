...
//                "--hms-mirror.config.align-locations=true",
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/cdp_cdp/so_mao_wd_dc"
        })
@Slf4j
public class Test_so_mao_wd_dc extends E2EBaseTest {
...
//        assertEquals("Return Code Failure: " + rtn + " doesn't match: " + check, check, rtn);
    ...
    public void returnCodeTest() {
        ...
        // Can't migrate acid tables with distcp.

        // Verify the return code.
        long check = 3L;
        // The distcp gets reset for RELATIVE.
