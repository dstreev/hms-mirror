...
//                "--hms-mirror.config.migrate-acid=true",
                "--hms-mirror.config.migrate-acid=true",
                "--hms-mirror.config.warehouse-plans=assorted_test_db=/my/warehouse/external:/my/warehouse/managed",
...
//                "--hms-mirror.config.distcp=true",
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/sql_ma_wps"
        })
@Slf4j
public class Test_sql_ma_wps extends E2EBaseTest {
