...
//                "--hms-mirror.config.reset-to-default-location=true",
                ...
                "--hms-mirror.config.global-location-map=/apps/hive/warehouse=:/warehouse/tablespace/managed/hive",
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/so_wd_epl_rdl_dc_glm"
        })
@Slf4j
public class Test_so_wd_epl_rdl_dc_glm extends E2EBaseTest {
...
//        validateDBManagedLocation(resultsMirrors[0], Environment.RIGHT, "hdfs://HOME90/warehouse/tablespace/managed/hive/tpcds_bin_partitioned_orc_10.db");
    ...
    public void dbLocationTest() {
        validateDBLocation("tpcds_bin_partitioned_orc_10", Environment.RIGHT,
                "hdfs://HOME90/warehouse/tablespace/external/hive/tpcds_bin_partitioned_orc_10.db");
    }

    @Test
    public void dbManagedLocationTest() {
        validateDBManagedLocation("tpcds_bin_partitioned_orc_10", Environment.RIGHT,
                "hdfs://HOME90/warehouse/tablespace/managed/hive/tpcds_bin_partitioned_orc_10.db");
    }
    ...
    public void partitionLocationTest_01() {
        validatePartitionLocation("tpcds_bin_partitioned_orc_10",
                "web_sales", Environment.RIGHT,
                "ws_sold_date_sk=2452033", "hdfs://HOME90/warehouse/tablespace/external/hive/tpcds_bin_partitioned_orc_10.db/web_sales/ws_sold_date_sk=2452033");
    }
    ...
    public void partitionLocationTest_02() {
        validatePartitionLocation("tpcds_bin_partitioned_orc_10",
                "web_sales", Environment.RIGHT,
                "ws_sold_date_sk=2452036", "hdfs://HOME90/warehouse/tablespace/external/hive/tpcds_bin_partitioned_orc_10.db/web_sales/ws_sold_date_sk=2452036");
    }
