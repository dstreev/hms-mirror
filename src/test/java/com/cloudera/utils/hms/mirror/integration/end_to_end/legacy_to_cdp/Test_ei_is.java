...
@SpringBootTest(classes = Mirror.class,
        args = {
                "--hms-mirror.config.comment='Test Export Import with Intermediate Storage'",
...
//                "--hms-mirror.config.distcp=true",
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/ei_is"
        })
@Slf4j
public class Test_ei_is extends E2EBaseTest {
...
//        assertEquals("Return Code Failure: " + rtn + " doesn't match: " + check, check, rtn);
    ...
    public void returnCodeTest() {
        // 1 table failure due to excessive partition count.
