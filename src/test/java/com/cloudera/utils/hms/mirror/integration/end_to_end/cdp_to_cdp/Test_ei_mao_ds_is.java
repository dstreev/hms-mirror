...
@SpringBootTest(classes = Mirror.class,
        args = {
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/cdp_cdp/ei_mao_ds_is"
        })
@Slf4j
public class Test_ei_mao_ds_is extends E2EBaseTest {
...
//        assertEquals("Return Code Failure: " + rtn + " doesn't match: " + check, check, rtn);
    ...
    public void returnCodeTest() {
        ...
        long check = 2L; // Partitions counts too high.
