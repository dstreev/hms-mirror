...
//                "--hms-mirror.config.migrate-acid=true",
                "--hms-mirror.config.migrate-acid-only=4",
...
//                "--hms-mirror.config.reset-to-default-location=true",
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/so_mao_4"
        })
@Slf4j
public class Test_so_mao_4 extends E2EBaseTest {
...
//        assertEquals("Return Code Failure: " + rtn + " doesn't match: " + check, check, rtn);
    ...
    public void returnCodeTest() {
        ...
        // distcp on acid tables.  Won't work.
        long check = 3L;
