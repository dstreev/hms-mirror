...
//                "--hms-mirror.config.sync=true",
                "--hms-mirror.config.table-filter=call_center|store_sales",
...
//                "--hms-mirror.config.distcp=true",
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/so_ro_sync"
        })
@Slf4j
public class Test_so_ro_tf extends E2EBaseTest {
