...
@SpringBootTest(classes = Mirror.class,
        args = {
                "--hms-mirror.config.comment='Test HYBRID Strategy with ACID table. This will ALIGN the locations.'",
...
//                "--hms-mirror.config.distcp=true",
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/hybrid_ma_da_cs"
        })
@Slf4j
public class Test_hybrid_ma_epl extends E2EBaseTest {
