...
@SpringBootTest(classes = Mirror.class,
        args = {
                "--hms-mirror.config.comment='Test HYBRID Strategy with ACID table that will be DOWNGRADED.  Will use Intermediate Storage.'",
...
//                "--hms-mirror.config.distcp=true",
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/hybrid_ma_da_is"
        })
@Slf4j
