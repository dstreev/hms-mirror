...
@SpringBootTest(classes = Mirror.class,
        args = {
                "--hms-mirror.config.comment='Test HYBRID Strategy with ACID tables ONLY that are DOWNGRADED using Common Storage.'",
...
//                "--hms-mirror.config.distcp=true",
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/hybrid_mao_da_cs"
        })
@Slf4j
