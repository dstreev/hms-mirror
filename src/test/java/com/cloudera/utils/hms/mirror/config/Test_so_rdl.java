...
//                "--hms-mirror.config.distcp=true",
                ...
                "--hms-mirror.config.suppress-cli-warnings=true",
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/config/so_rdl"
        })

@Slf4j
public class Test_so_rdl extends E2EBaseTest {
