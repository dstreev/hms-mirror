...
public class ConfigTest {
    ...
    public static HmsMirrorConfig deserializeResource(String configResource) throws IOException {
        ...
        if (configURL != null) {
            ...
            hmsMirrorConfig = mapper.readerFor(HmsMirrorConfig.class).readValue(configDefinition);
        } else {
