...
//                "--hms-mirror.config.reset-to-default-location=true",
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/so_dc"
        })
@Slf4j
public class Test_so_dc extends E2EBaseTest {
...
//        assertEquals("Return Code Failure: " + rtn + " doesn't match: " + check, check, rtn);
    ...
    public void dbLocationTest() {
        validateDBLocation("assorted_test_db", Environment.RIGHT, "hdfs://HOME90/warehouse/tablespace/external/hive/assorted_test_db.db");
    }
    ...
    public void tableLocationTest() {
        validateTableLocation("assorted_test_db", "ext_part_01", Environment.RIGHT, "hdfs://HOME90/warehouse/tablespace/external/hive/assorted_test_db.db/ext_part_01");
    }
