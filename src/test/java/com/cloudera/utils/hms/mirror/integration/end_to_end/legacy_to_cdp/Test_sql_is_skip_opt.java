...
//                "--hms-mirror.config.distcp=true",
                "--hms-mirror.config.skip-optimizations=true",
                "--hms-mirror.conversion.test-filename=/test_data/assorted_tbls_03.yaml",
                "--hms-mirror.config.filename=/config/default.yaml.hdp2-cdp",
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/sql_is_skip_opt"
        })
@Slf4j
public class Test_sql_is_skip_opt extends E2EBaseTest {
