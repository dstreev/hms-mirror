...
//                "--hms-mirror.config.align-locations=true",
                ...
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/legacy_cdp/so_ma_wd_epl_w_parts"
        })
@Slf4j
public class Test_so_ma_wd_epl_w_parts extends E2EBaseTest {
