...
@SpringBootTest(classes = Mirror.class,
        args = {
                "--hms-mirror.config.output-dir=${user.home}/.hms-mirror/test-output/e2e/cdp/sql_leg_mngd_bucket_ip_t5",
//                "--hms-mirror.config.downgrade-acid=true",
                "--hms-mirror.config.in-place=true",
                "--hms-mirror.config.migrate-acid=5",
...
@Slf4j
public class Test_sql_leg_mngd_bucket_ip_t5 extends E2EBaseTest {
//
